    ...
    <div className="bg-slate-950 min-h-screen text-slate-100 p-4 md:p-6 font-sans flex flex-col justify-between" id="boxoffice-main">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="border-b border-slate-800 pb-5 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            <span className="text-xs bg-red-600 font-bold px-2.5 py-1 rounded-full uppercase tracking-widest text-white">
              BOLETERÍA PRESENCIAL (TICKETING TERMINAL)
            </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-bold bg-emerald-950 text-emerald-400 border border-emerald-900 px-3 py-1.5 rounded">
              Cachero Impresoras: ONLINE
            </span>
          </div>
        </div>
                ...
                {currentShow && (
                  <>
                    ...
                    {!currentMovie?.allowSeatSelection && (
                      <div>
                        <span className="text-[10px] text-slate-500 uppercase font-bold block mb-1.5">Manejo de Asientos (Requisito)</span>
                    ...
                    <div>
                      <span className="text-[10px] text-slate-500 uppercase font-bold block mb-1.5">Médio de Pago Presencial</span>
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          type="button"
